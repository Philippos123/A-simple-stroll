...
def main():
    """
    The main() function is defined, which serves as the entry point for the
    game.
...
def introduction():
    """
    The introduction() function provides an introductory message about the
    game's premise.
    """
    ...
    print("be playing.\n")
    print("__________________________________________________________________")
    print("\nYou will leave your safe heaven to take a stroll in the big and")
    print("scary world.")
    print("Are you going to make new friends? Enjoy the stroll? Or never come")
    print("home again?!")
    print("Every outcome will depend on your choices while you")
    print("take your stroll.")


def start_game():
    """
    The start_game() function prompts the player to enter their username
    and validates it to ensure it contains only letters.
    ...
    while True:
        if username.isalpha():
            ...
            print(f"Welcome {username}, you are about to enter on a ")
            print("new adventure! I wish you all the luck!....")
            print("You probobly need it")
            start_stroll(username)
            break
        else:
            print("\nIm sorry,")
...
def start_stroll(username):
    """
    The start_stroll(username) function describes the beginning of the game
    when the player decides to take a stroll.
    It presents the player with a choice to go to the city or the forest.
    """
    print("\nYou just woke up, the clock is 11:00 am, you woke up a bit late")
    print("becuse you were talking to a friend the entire night.")
    print("The sun is shining and you decide that you want to take a stroll,")
    print("so you jump in to the shower, put some cloths on and")
    print("walks out from your house")
...
def city_tail(username):
    ...
    print("......\n")
    print("\n10 minutes later")
    print("You walk around in the city and notice a young boy is running")
    print("with a bag in his hands,")
    print("You see three huge guys running after him screaming")
    print("COME BACK HERE BOY!'\n")
...
def hide_boy(username):
    """
    The hide_boy(username) function is called if the
    player chooses to hide the boy.
    It continues the story and introduces a character
    named person_c who interacts with the player.
    """
    ...
    print("The boy takes of and runs into an allay nearby. Everything")
    print("was back to normal again.")
...
def coffe_tail(person_c, person_c_g, username, pronoun):
    """
    The coffe_tail() function continues the story from the coffee shop, where
    the player can choose to follow person_c or not.
    """
    print(f"\n{person_c}: Come on {username} let´s go and take a coffee?")
    print("I know a place?")
    ...
    while True:
        ...
        if follow == "y":
            ...
            print("Im sorry you need to answer with simple y or n to")
            print("keep playing")


def coffeplace(person_c, person_c_g, username, pronoun):
    """
    The coffeplace() function describes the coffee shop scenario and
    the player's choices.
    """
    print(f"\n{person_c}: Oh im so glad you want to take a coffe!")
    print(f"{person_c}: I know a place walking distance from the city!")
    print("let´s go!\n")
    print(".............")
    print("\n20 minutes later")
    print(f"You are tired of walkning but {person_c} told you it")
    print("was 5 minutes left.")
    print(f"You notice that {pronoun} has scars on the arms and")
    print("looks paranoid, always looking around.")
    print(f"You dont think much about it, on the other hand you")
    print(f"notice that {pronoun} taking you to a bit suspicious")
    print("place by the forst.\n")
    cabin_tail(person_c, username, pronoun)


def cabin_tail(person_c, username, pronoun):
    """
    The cabin_tail() function is called when the player reaches a cabin
     and encounters a dangerous situation.
    """
    print(f"\n{pronoun} points at a small old red cabin and say.")
    print("'We are here!")
    print(f"come on {username}'")
    print(f"You feel a bit sceptical to this, beacue you heard of a")
    print(f"young girl and an middle age {person_c_g} disapeard arond")
    print("here somwehere")
    print("All of a sudden, you notice someone standing behind the")
    print("trees in the woods close by the cabin.")
    print(f" {person_c} pushes you behind a wall and whispers in your ear.")
    print("'Listen to me or die inside this cabin...'")
...
def inside_cabin(person_c, username, pronoun):
    """
    The inside_cabin() function continues the story inside the cabin,
     revealing more details about the situation.
    """
    print(f"\nBoth of you walk inside the cabin and {pronoun} whispers")
    print("in your ear")
    print(f"{person_c}: Did you notice the person behind the trees?")
    print("Yes? What about it?")
    print(f"{person_c}: You know that two people got kidnapped a couple")
    print("of weeks ago?")
    print("Yeah?.......\n")
    print(f"{person_c}: That was me and a little girl.")
    print("Why did you bring me here then?!")
    print(f"{person_c}: I saw your heroic act and i hope that you could")
    print("save us....")
    print(f"{person_c}: The man that kidnapped us is mr.Jansson")
    print("But wait?! That is my neighbour?!")
    print(f"{person_c}: He want´s us to charm people here and kill them")
    print("He´s a... eh cannibal")
    print("Wait what?! Is he going to eat me?!")
    print(f"{person_c}: He forces us to eat his 'catch' and")
    ...
    while True:
        if user_choice == "1":
            ...
            print("You slam up the dorr right in the face of")
            print("Mr.Jansson and escapes")
            ...
            print(f"Hello {username} it´s Mr.Jansson,")
...
def final_act(person_c, username, pronoun):
    """
    The final_act() function presents the player with choices on how to
     deal with the situation inside the cabin.
    """
    print("\nDOOK DOOK DOOK")
    ...
    while True:
        if user_choice == "1":
            ...
            print(f"The dorrs open and mr.Jansson says 'Good job {person_c}")
            print("we are going to eat good tonight'")
            print(f"You start to shake and you see how scared {person_c}")
            print("looks, you look back at mr.Jansson")
            print("DONK!\n")
            print("You wake up strapped to a bloody kithen table ")
            print(f"Mr.Jansson comes up close to your face and says")
            print(f"'Sleep well {username}'\n")
            death()
        elif user_choice == "3":
            ...
            print("Mr.Jansson: {person_c} if you dont tell me in three")
            print("seconds, you will be served as dinner tonight...")
...
def final_act_wardrobe(person_c, username, pronoun):
    """
    The final_act_wardrobe function tell the player the story if they choose
     the wardrobe to hide, and win the game
    """
    ...
    print("You see that mr:jansson walks down to the basement and you notice")
    print("a shotgun beside you.")
...
def final_act2(person_c, username, pronoun):
    """
    final_aces(): This function represents the final part of the game where the
    player faces a life-or-death situation.
    The player is given three choices: hiding in the wardrobe, running for a
    kitchen knife, or hiding under the bed.
    Depending on their choice, different outcomes occur, leading to either
    death or survival.
    """
    ...
    while True:
        if user_choice == "1":
            ...
            print(f"You notice that {person_c} start to walk towards")
            print("the wardrobe")
            print(f"{person_c}: Im sorry {username}...")
            print("But i can´t trust you...")
            print("Mr.Jansson open the wardrobe,")
            print("you notice the gun but dont have time enough to load it...")
            print(f"Well well well... hello {username}\n")
            print("Donk!")
            death()
        elif user_choice == "2":
            print("\nYou start the run for the kitchen knife!")
            print(f"The dorrs open and mr.Jansson says")
            print(f"'Good job {person_c} we are going to eat good tonight'")
            print(f"You start to shake and you see how scared")
            print(f"{person_c} looks, you look back at mr.Jansson")
            print("DONK!\n")
            print("You wake up strapped to a bloody kithen table ")
            print(f"Mr.Jansson comes up close to your face and says")
            print(f"'Sleep well {username}' \n")
            ...
            print(f"Mr.Jansson: {person_c}!! Where is {username}?")
            print(f"{person_c} standing there quiet")
            print(f"Mr.Jansson: {person_c} if you dont tell me in three")
            print("seconds, you will be served as dinner tonight...")
            print(f"{person_c}: I am so sorry {username}....")
            print(f"{person_c}: He´s under the bed")
            print(f"Mr.Jansson: Well well... Hello there {username}")
...
def congrat(username):
    """
    congrat(username): This function is called when the player
    survives the game.
    It congratulates the player and asks if they want to play again.
    If the player chooses to play again, it calls the start_game()
    function (which is not defined in the provided code).
    """
...
def forest_tail(username):
    ...
    They hear a child crying and are given the choice to find the child or
    ignore the sound.
    """
    print("\nYou are excited! You are about to go on a excited")
    print("stroll in the woods")
    print("10 minutes later......")
    print("You are starting to walk deeper and deeper inside")
    print("the woods")
    print("You start to remember a artical you saw couple of")
    print("weeks ago about two girls that went missing inside these woods")
...
def find_girl(username):
    ...
    to find the child.
    They encounter a girl named Molly and are given choices that
    lead to different outcomes.
    """
    print("\nYou walk around in the woods for 10 minutes untill you")
    print("find a little girl untill a old tree.")
    ...
    print("Molly:Okey! My father will be so happy to see that i have")
    print("brought a friend!")
    print("Molly whisper for her self....'Haha my belly to'")
    print(".............")
    print("\n20 minutes later")
    print("You are tired of walkning but Molly told you it")
    print("was 5 minutes left.")
    print("You notice that she has scars on the arms and")
    print("looks paranoid, always looking around.")
    print("You dont think much about it, on the other hand you")
    print("notice that she taking you to a bit suspicious place by the forst.")
    print("You see a shadow following you to a red old cabin")
    print("outside the forest.")
    print("Molly asks you 'Do you wanna meet my father?")
    print("My sibling is out working right now so it will be just us'")
...
def girl_cabin(username):
    ...
    It presents the player with a choice to drink tea or not, which leads
...
def soon_death(username):
    ...
    the tea.
    It leads to a scenario where the player falls unconscious and faces a
    grim fate.
    """
    print("\nYou drink up all the tea Molly gave you, after a couple")
    print("of minutes you feel dizzy and tired..")
...
def fight_for_life(username):
    ...
    the tea.
    It involves a confrontation with Molly, and the player must make choices
    to survive.
    """
    ...
    print("Molly: NO!!! Dont go! YOU NEED TO STAY!")
    print("YOU WILL MAKE MY BELLY STOP CRY")
    print("You got scared, you turn around and see")
    print("Molly standing with a knife")
...
def gunfight(username):
    """
    gunfight(username): This function is called when the player
    decides to go for the gun.
    ...
    while True:
        if user_choice == "y":
            print("\nMr.Jansson: I will help you! Just walk slowly towards")
            ...
            print("Mr.Jansson: Im sorry my friend but you heard her....")
            print("She´s hungry")
            print("You aim your gun at Mr.Jansson and pulls")
            print("the trigger twice and then turn at Molly and fires once.")
            print("You throw the gun and start´s running home")
            print("and remember that Molly mention a sister...")
            print("You open your dorr and enters your safe heaven.")
            print("Calls the cops and tell them about everything")
...
def home_safe(username):
    """
    home_safe(username): This function is called if the player decides to run
    away from Molly.
    It describes the player's return home and the discovery of disturbing news
    about Mr. Jansson, the neighbor.
    """
    print("\nYou keep walkning home and walks in to your safe heaven.")
    print("Everything is normal, but you notice in the morning paper that")
    print("a young man have been missing for 2 days.")
    print("Around the same place as the old cabin.")
    print("Three months later.....")
    print("Newspapper: This morning did the police finally found the girls")
    print("that went missing four months ago. At a man calld")
    print("Mr.Jansson summer cabin")
    print("Informations tells us that under these four months they")
    print("have been kidnapping and eating travelers")
